...
namespace BedstedFinalProject.Controllers
{
    ...
    public class AccountsController : ControllerBase
    {
        ...
        public AccountsController(JwtAuthenticationManager jwtAuthenticationManager, FinancialInstitutionContext context)
        {
        ...
        public async Task<ActionResult<Account>> PostAccount(Account account)
        {
          if (_context.Accounts == null)
          {
              return Problem("Entity set 'FinancialInstitutionContext.Accounts'  is null.");
          }
