...
namespace BedstedFinalProject.Controllers
{
    ...
    public class EmployeesController : ControllerBase
    {
        ...
        public EmployeesController(JwtAuthenticationManager jwtAuthenticationManager, FinancialInstitutionContext context)
        {
        ...
        public async Task<ActionResult<Employee>> PostEmployee(Employee employee)
        {
          if (_context.Employees == null)
          {
              return Problem("Entity set 'FinancialInstitutionContext.Employees'  is null.");
          }
